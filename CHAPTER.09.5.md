...
> 
>> **什么是BOX？**
>> * BOX是币本位的区块链 ETF 、保本基金。 
>> * BOX的一切运营，一切往来，全部公开透明，且，严格遵守 “百分之百保证金制度”。  
>> * 用BOX token（区块链化凭证）提走你曾经累计投入的多少 BTC/EOS/XIN。         
>> * BOX本身没有收益。但是， BOX的二级市场交易所会有。[b.watch](https://b.watch) 会定期向 BOX持有者空投 50% 的二级市场手续费收入（双向各千分之一）；另外50% 手续费收入，构成 [b.watch](https://b.watch) 的基本商业模式基本组成。[b.watch](https://b.watch) 的股份会根据一定的算法计算社区贡献以积分形式分发给定投社区里的践行者（在恰当的时候开放二级市场交易）。
>> * [b.watch](https://b.watch)最终所有的股份都发放出去，不单独保留。  
>> * 人员成本、设备成本等由李笑来个人负责。
