...
>> * 有多少BOX token（区块链化凭证）就可以按比例提走多少 BTC/EOS/XIN。         
>> * BOX本身没有收益。但是， BOX的二级市场交易所会有。   
>>> * [b.watch](https://b.watch) 会定期向 BOX持有者空投 50% 的二级市场手续费收入（双向各千分之一）；  
>>> * 另外50% 手续费收入，构成 [b.watch](https://b.watch) 的基本商业模式基本组成。[b.watch](https://b.watch) 的股份会根据一定的算法计算社区贡献以积分形式分发给定投社区里的践行者（在恰当的时候开放二级市场交易）。
